...
class TransferDataReceiverClientRunnable(private val host: String, private val filepath: String, private var listener:TransferDataReceiveListener?) : Runnable {
